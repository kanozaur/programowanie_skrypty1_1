...
#znajdz nazwe stcji po id_stacji
numer_stacji=input("Podaj id stacji:")
nazwa_stacji=""
for i in range(dlugosc):
...
########
#wpisanie przyszlej daty gromadzenia danych
#polaczenie programu z adresem danepubliczne